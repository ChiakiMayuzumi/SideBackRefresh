...
public abstract class BaseListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    protected static final int VIEW_TYPE_LOAD_MORE_FOOTER = 1;
    ...
    public int getItemCount() {
        return getDataCount() + (isLoadMoreFooterShown ? 1 : 0) + (isHeaderShown ? 1 : 0);
    }
    ...
    public void setIsHeaderShown(boolean isHeaderShown) {
